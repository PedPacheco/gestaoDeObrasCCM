...
export const mockResponseDetails = {
  ...
  moExecutadoPontoAPonto: null,
  moPendentePontoAPonto: 2000,
  ...
  data_envio: new Date('2026-06-06'),
  prazo_viabilidade: 'FORA DO PRAZO',
  viabilidade_aprovada: true,
  ...
  servicos: [
    {
      ...
      ponto: 'P001',
      numeroOperacao: '0010',
      descricaoOperacao: 'Instalação de cabo spacer 15kV',
      material: '300000451',
      textoBreve: 'CABO SPACER 15KV 185MM',
      dataProgramada: new Date('2024-09-19T00:00:00.000Z'),
      qtdePlanejada: 120,
      qtdeAdicional: 15,
      viabilizado: 120,
      qtdeProgramada: 135,
    ...
    },
    {
      ...
      ponto: 'P002',
      numeroOperacao: '0020',
      descricaoOperacao: 'Retirada de cruzeta de madeira',
      material: '300000782',
      textoBreve: 'CRUZETA MADEIRA 2400MM',
      dataProgramada: new Date('2024-09-19T00:00:00.000Z'),
      qtdePlanejada: 8,
      qtdeAdicional: 0,
      viabilizado: 6,
    ...
    },
    {
      ...
      ponto: 'P001',
      numeroOperacao: '0030',
      descricaoOperacao: 'Montagem de estrutura tipo N1',
      material: null,
      textoBreve: 'MO MONTAGEM ESTRUTURA N1',
      dataProgramada: new Date('2024-09-19T00:00:00.000Z'),
      qtdePlanejada: 10,
      qtdeAdicional: 2,
      viabilizado: 10,

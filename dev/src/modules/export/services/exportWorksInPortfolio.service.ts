...
export class exportWorksInPortfolioService {
  ...
  async export(worksData: any[], response: Response) {
    ...
    worksheet.columns = [
      ...
      { header: 'Qtde pend', key: 'qtde_pend', width: 10 },
      { header: 'MO planejada', key: 'mo_planejada', width: 10 },
      { header: 'Status', key: 'status.status', width: 10 },
      { header: 'Parceira', key: 'turma', width: 20 },
      { header: 'Executado da obra', key: 'executado', width: 10 },
      { header: 'Data Programada', key: 'first_data_prog', width: 10 },
      ...
      { header: 'Data empreitamento', key: 'data_empreitamento', width: 15 },
      { header: 'Empreendimento', key: 'empreendimento', width: 15 },
    ];

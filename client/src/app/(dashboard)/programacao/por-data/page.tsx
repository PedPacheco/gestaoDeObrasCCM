...
export default async function ScheduleForDay() {
  ...
  const columns = {
    ...
    mo_prog: "MO Programada (SAP)",
    mo_exec: "MO Executada (SAP)",
    moPlanejadaPontoAPonto: "MO Programada (Ponto a Ponto)",
    moExecutadoPontoAPonto: "MO Executada Ponto a Ponto)",
    mo_forecast: "Forecast serviço",
    mat_forecast: "Forecast material",

...
export const OldSchedulesSchema = (isInsert?: boolean) =>
  z
    .object({
      id: z.number(),
...
export const OldEquipmentItemSchema = z.object({
  equipment: z.string(),
...
export const OldExecutionReportSchema = z
  .object({
    id: z.number(),
    idUser: z.number(),
    ...
    appliedEquipment: z.array(OldEquipmentItemSchema),
    hasEquipmentRemoved: z.boolean(),
    equipmentRemoved: z.array(OldEquipmentItemSchema),
...
export const OldValidationSchedulesSchema = (
  initialExecValue: string | null | undefined,
  isInsert: boolean,
) =>
  OldSchedulesSchema(isInsert)
    .safeExtend({
      executionReport: z.union([OldExecutionReportSchema, z.null()]).optional(),
    })
    .check((ctx) => {
      ...
      if (
        ...
        const result = OldExecutionReportSchema.safeParse(executionReport);

  ...
  return (
    <div className="flex flex-col overflow-y-auto w-full h-full py-8 xl:flex-row xl:justify-around">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full">
          <div className="flex flex-col mr-4">
            ...
            <DataItem
              label="CAPEX Total"
              value={FormatCurrency(data.capex_mat_plan + data.capex_mo_plan)}
            />
          </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full">
          <div className="flex flex-col mr-4">
            <p className="mb-2 text-center ml-24 font-semibold">SAP</p>
            <DataItem
              label="Planejado"
              value={FormatCurrency(data.mo_planejada)}
            />
            <DataItem
              label="Executado"
              value={

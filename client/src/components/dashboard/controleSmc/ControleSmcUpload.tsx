...
interface ControleSmcUploadProps {
  onFile: (file: File) => void;
  isPending: boolean;
  compact: boolean;
}

export function ControleSmcUpload({
  onFile,
  isPending,
  compact,
}: ControleSmcUploadProps) {
        ...
        {compact ? (
          ...
          <>
            ...
            <span className="text-white font-bold text-lg">
              Arraste a planilha &quot;Controle SMC - COMPET&quot; aqui
            </span>

            <span className="text-zinc-400 text-sm text-center max-w-md">
              Aceita o arquivo .xlsx exportado do OneDrive, lendo a aba
              &quot;Núcleos SMS - Geral&quot;. Os dados ficam apenas nesta

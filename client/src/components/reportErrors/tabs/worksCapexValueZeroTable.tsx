...
interface WorksCapexValueZeroTableProps {
  worksCapexValueZeroData: any[];
}

export function WorksCapexValueZeroTable({
  worksCapexValueZeroData,
}: WorksCapexValueZeroTableProps) {
  ...
  return (
    <TableContainer component={Paper}>
      <Table stickyHeader>
        ...
        <TableBody>
          {worksCapexValueZeroData.map((row, i) => {
            return (
